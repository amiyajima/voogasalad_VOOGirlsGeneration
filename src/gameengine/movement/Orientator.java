...
public class Orientator {
	...
	/**
	 * Calculates the amount that the piece needs to turn between each unit of
	 * movement so that it is facing the proper direction
	 * 
	 * @param currentFacing
	 *            - the direction the piece is currently facing
	 * @param from
