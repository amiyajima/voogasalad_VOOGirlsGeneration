...
public class Grid extends Pane {
	...
	public Grid(int width, int height, int tilesize) {
		...
		// will be adding patch to patchdata whenever a new patch is put onto
		// the grid
...
//		this.setDragEvent();
	 ...
	 * 
	 * @param x
	 *            : The X coordination of the tile from the left smallest to the
	 *            right largest.
	 * @param y
	 *            : The Y coordination of the tile from the bottom smallest to
	 *            the top largest.
	...
	/**
	 * Returns a list of all selected tiles in the Grid
	 * 
	 * @return A list of all selected tiles in the Grid
	 */
