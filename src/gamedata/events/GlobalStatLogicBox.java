...
/**
 * Stat Logic Box that displays available players to allow for global action of modifying player
 * stats. 
 * 
 * Modeled after TotalLogicBox
 * 
 * @author annamiyajima
 *
 */

public class GlobalStatLogicBox extends VBox {
    ...
    public GlobalStatLogicBox (StatsTotalLogic stl, PlayerData playerData) {
    ...
    private void initStatsModifier (StatsTotalLogic stl) {
        ...
        // TODO: retrieve number of players from mengen
//        int numPlayers = myPlayerData.getNumPlayers();
//        for(int i = 1; i<= numPlayers; i++){
//            myStatsRefChoice.getItems().add("player " + i);
//        }
//        myStatsRefChoice.getItems().addAll("player 1", "player 2");
