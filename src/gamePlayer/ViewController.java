...
public class ViewController {
    ...
    public ViewController (Stage s) throws UnsupportedAudioFileException, IOException,
     ...
     */
    @FXML
    protected void openInitialMenu () throws UnsupportedAudioFileException, IOException,
                                     LineUnavailableException {
    ...
    public void toggleBackgroundMusic () throws UnsupportedAudioFileException, IOException,
                                        LineUnavailableException {
    ...
    private void showHighScoreInfo (String highScorer, int highScore) {
        ...
        go.setOnMouseClicked(event -> addEntryToHallOfFame(dialog, nickname.getText(),
                                                           score.getText()));
