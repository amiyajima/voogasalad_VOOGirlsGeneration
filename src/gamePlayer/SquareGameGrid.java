...
public class SquareGameGrid extends GameGrid {
	...
	public void update(Observable o, Object arg) {
		if (o instanceof Level) {
			...
			populateGrid(((Level) o).getGrid().getAllPatches(), ((Level) o)
					.getGrid().getAllPieces());
	...
	/**
	 * The method to initialize the Grid. it populates the grid with stackpanes
	 * that allows for adding pieces and patches images.
	 * 
	 */
	@Override
